...
RUN aws s3 cp --recursive s3://sugarstore/T2304Linux_TimeTick /home/ue4/project
...
RUN chmod +x /home/ue4/project/T2304.sh

# Switch to the non-root user
USER ue4user

# Set the project as the container's entrypoint
ENTRYPOINT ["/home/ue4/project/T2304.sh", "-RenderOffscreen", "-AllowPixelStreamingCommands" ,"-PixelStreamingHideCursor" ,"-PixelStreamingWebRTCMaxFps=30", "-PixelStreamingWebRTCDisableReceiveAudio","-FullStdOutLogOutput", "-ForceRes", "-ResX=1920", "-ResY=1080"]